<?php
	...
	setPageTitle("BIONAL setup");

	if(!isSet($_POST['setup']))
	{
			$license = file_get_contents("./LICENSE");
			$form = <<<EOT
			<h1>BIONAL Setup</h1><br />
			<hr /><br />
...
EOT;
		...
		{
			addToBody("Your server has one more issues that makes it imcompatible with BIONAL.");
			finishPage();
		}
	}
		...
		if(!isSet($_POST['server_addr']))
		{
			...
			<div style="text-align: left; width: 75%">
				<form method="POST">
					...
					<tr><td>Forum name/Site name:<span class="rightAlign"><input type="text" name="sitename" value="BIONAL" required/></span></td><td class="finetext">This will show up in the brower's title bar when visiting the home page.</td></tr>
